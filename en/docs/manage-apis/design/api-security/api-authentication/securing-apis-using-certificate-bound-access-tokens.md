...
2. [Create an API](https://apim.docs.wso2.com/en/latest/manage-apis/design/create-api/create-rest-api/create-a-rest-api/)     
...
1. Navigate to the certificates tab in Postman settings.
     ...
     [![Add the certificate to Postman](https://apim.docs.wso2.com/en/latest/assets/img/learn/add-certificate-to-postman.png)
    
2. Add the certificate and private key.

     [![Provide certificate and private key](https://apim.docs.wso2.com/en/latest/assets/img/learn/provide-crt-and-private-key.png)
